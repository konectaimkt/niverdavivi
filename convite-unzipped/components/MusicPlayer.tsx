...
export const TRACK_OPTIONS = [
  { name: "Violão Acústico Suave (Padrão)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3" },
  { name: "Melodia Romântica de Piano", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3" },
  { name: "Dreamy Lo-Fi Instrumental", url: "https://assets.mixkit.co/music/preview/mixkit-beautiful-dream-12.mp3" },
];
